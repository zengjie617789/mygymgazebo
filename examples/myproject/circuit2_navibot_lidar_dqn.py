...
if __name__ == '__main__':
    ...
    env = gym.make('GazeboNavibotLidarNn-v0')
    outdir = '/home/control511/KerasModel/navibot/gazebo_gym_experiments/'
    path = '/home/control511/KerasModel/navibot/turtle_c2_dqn_ep'
